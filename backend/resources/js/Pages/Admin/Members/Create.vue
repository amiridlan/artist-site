      ...
      <Section title="Basic Info">
        <div class="grid grid-cols-2 gap-4">
          ...
          <FormField label="Generation" required :error="form.errors.generation">
            <CreatableSelectInput v-model="form.generation" :options="generationOptions" placeholder="Select…" :error="form.errors.generation" />
          </FormField>
...
const props = defineProps({ generationOptions: { type: Array, default: () => [] } })
