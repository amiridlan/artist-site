<template>
  ...
  >
    ...
    <div class="relative aspect-square overflow-hidden bg-neutral-900">
      ...
      <!-- Featured Badge -->
      <div v-if="release.featured" class="absolute top-2 right-2">
      ...
      <!-- Upcoming Badge -->
      <div v-if="isUpcoming" class="absolute bottom-2 right-2">
        <span class="px-2 py-1 bg-primary-600 text-white rounded-full text-xs font-bold uppercase animate-pulse">
          Coming Soon
        </span>
      </div>
    </div>
