  ...
  >
    ...
    <div class="relative h-48 md:h-56 overflow-hidden">
      ...
      <div v-if="article.featured" class="absolute top-4 right-4">
        <span class="px-3 py-1 bg-primary-400 text-neutral-900 rounded-full text-xs font-bold uppercase tracking-wide flex items-center gap-1">
    ...
    <div class="p-5 md:p-6">
      ...
      <!-- Excerpt -->
      <p class="text-neutral-600 text-sm md:text-base mb-4 line-clamp-3 leading-relaxed">
        {{ article.excerpt }}
      </p>
