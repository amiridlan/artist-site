<template>
  <section class="featured-news-banner relative rounded-2xl overflow-hidden shadow-2xl mb-12">
    ...
    <div class="relative z-10 container mx-auto px-6 md:px-8 py-12 md:py-16 lg:py-20">
      <div class="max-w-2xl">
        <!-- Featured Badge -->
        <div class="inline-flex items-center gap-2 px-4 py-2 bg-primary-400 text-neutral-900 rounded-full font-bold uppercase text-sm mb-4 md:mb-6 animate-pulse">
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
          ...
          <button
            ...
            class="btn-featured group px-6 py-3 bg-primary-500 text-white rounded-full font-outfit font-semibold uppercase text-sm tracking-wide hover:scale-105 transition-all duration-300 hover:shadow-neon flex items-center gap-2"
          >
            Read Full Story
    ...
    <!-- Decorative Element -->
    <div class="absolute bottom-0 right-0 w-64 h-64 bg-primary-500 opacity-20 blur-3xl rounded-full transform translate-x-1/2 translate-y-1/2"></div>
  </section>
</template>
